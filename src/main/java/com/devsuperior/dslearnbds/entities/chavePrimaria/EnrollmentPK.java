package com.devsuperior.dslearnbds.entities.chavePrimaria;
...
public class EnrollmentPK implements Serializable{
	private static final long serialVersionUID = 1L;
		//classe auxiliar para definir chave primaria.
//	
	
	@ManyToOne
	@JoinColumn(name = "user_id" )
	private User user;    //referencia para usuario 
	
	@ManyToOne
	@JoinColumn(name = "offer_id" )
	private Offer offer;    //referencia para oferta 
